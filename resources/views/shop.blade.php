...
{{--        <div class="container">--}}
        ...
        <img src="{{$data['static_banner']->offer_image}}" alt="">
        </a>
{{--            <h1 class="display-4">Fluid jumbotron</h1>--}}
{{--            <p class="lead">This is a modified jumbotron that occupies the entire horizontal space of its parent.</p>--}}
{{--        </div>--}}
    </div>@if(Request::is('brands/*'))
        <h5 class="mb-3"><?php echo $brand_details[0]->name; ?></h5>
    @else
...
{{--                                 <h6><strong><span class="mdi mdi-approval"></span> Available in</strong> - <?php print_r($product->unit); ?></h6>--}}
                              ...
                              <div class="product-footer">
                                  <div class="add-product-cart{{$product->id}}">

                                      @if($product->quantity>0)

                                          <button type="button" class="btn btn-secondary btn-sm float-right add-cart-product" product_id="{{ $product->id }}"><i class="mdi mdi-cart-outline"></i> Add To Cart</button>
                                      @else
