                            ...
                            <div class="card checkout-step-one">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    <div class="card-body">
                                        ...
                                        @else
                                            <div class="form-check form-group" >
                                                <a href="javascript:void(0)" class="btn btn-lg btn-primary" id="add_address_btn"> Add New address</a>
                                            </div>
                                        @endif
                                    </div>
                                </div>
...
@section('js')
    ...
    <script>
        ...
        $('#add_address_btn').click(function (){
            ...
            window.location.href = "{{ route('add_address') }}"
        })
    </script>
    @endsection
